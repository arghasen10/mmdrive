...
files = glob.glob('/home/argha/Desktop/dangerous_driving_a/data25_09_22/sugandh_25_09_22/nexar_data/*B.dat')
files.sort()
plot_imu = []
time_then = []
for f in files:
...
# files = glob.glob('/home/argha/Desktop/dangerous_driving_a/data25_09_22/sugandh_25_09_22/mmwave_data/*.txt')
# files.sort()
# plot_noise = []
# time_then = []
# for f in files:
